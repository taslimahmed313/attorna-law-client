...
const Banner = () => {
    return (
      <div className="banner flex items-center justify-center p-4 text-white">
        <div className="banner-section">
          <div>
            <img
              className=" w-[350px] h-[430px] banner-img"
          ...
          <div className="">
            ...
            <h3 className="text-lg  uppercase text-center text-black font-medium bg-[#D9A86D] py-2 my-3 rounded-lg">
